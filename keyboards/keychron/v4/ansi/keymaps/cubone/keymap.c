...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_60_ansi(
        ...
        KC_LCTL,  KC_LGUI,    KC_LALT,                             LT(WIN_BASE, KC_SPC),                              KC_RALT,  MO(_FN1),  MO(_FN2),  KC_RCTL),
    ...
    [WIN_BASE] = LAYOUT_60_ansi(
        ...
        _______,  KC_LALT,     KC_SPC,   _______,     KC_MPLY,     KC_DEL,   KC_BSPC,  KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  _______,            KC_MPLY,
