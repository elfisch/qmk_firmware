...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_all(
        ...
        SC_LSPO,    KC_Z,       KC_X,       KC_C,       KC_V,       KC_B,       KC_N,       KC_M,       KC_COMM,    KC_DOT,     KC_SLSH,                            SC_RSPC,    _______,
        KC_LCTL,    KC_LGUI,    KC_LALT,                                        LT(1, KC_SPC),                                  KC_RALT,    KC_RGUI,    MO(2),      MO(3)
    ),
    [1] = LAYOUT_all(
    ...
    [2] = LAYOUT_all(
        ...
        _______,    _______,    KC_PAST,    _______,    _______,    _______,    _______,    QK_MAKE,    _______,    KC_PDOT,    KC_PSLS,                _______,    _______,
    ...
    [3] = LAYOUT_all(
        ...
        _______,    _______,    _______,    _______,    _______,    RGB_M_B,    RGB_M_SN,   _______,    _______,    _______,    _______,                _______,    _______,
        _______,    _______,    _______,                                        _______,                                        _______,    _______,    _______,    _______
    )
};
