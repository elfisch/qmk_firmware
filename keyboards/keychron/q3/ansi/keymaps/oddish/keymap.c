...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_tkl_ansi(
        ...
        KC_LCTL,  KC_LGUI,  KC_LALT,                                KC_SPC,   MT(MOD_RALT, KC_LEFT), LT(MAC_FN, KC_DOWN), LT(WIN_BASE, KC_UP), LT(WIN_FN, KC_RGHT),    KC_LEFT,  KC_DOWN,  KC_RGHT),
    ...
    [MAC_FN] = LAYOUT_tkl_ansi(
        ...
        _______,  _______,  _______,                      _______,                      KC_HOME,  _______,  KC_PGUP,   KC_END,                      _______,  _______,  _______),
    ...
    [WIN_BASE] = LAYOUT_tkl_ansi(
        ...
        NK_ON,   NK_OFF,    _______,                                _______,                                _______,  KC_PGDN,  _______, _______,   _______,  _______,  _______),
