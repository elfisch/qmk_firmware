#!/bin/bash
qmk compile -kb cannonkeys/db60/rev2 -km cubone && mkdir -p output && mv cannonkeys_db60_rev2_cubone.bin output/cannonkeys_db60_solder_cubone.bin
qmk compile -kb cannonkeys/db60/rev2 -km oddish && mkdir -p output && mv cannonkeys_db60_rev2_oddish.bin output/cannonkeys_db60_solder_oddish.bin
